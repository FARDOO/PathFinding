...
private:
    ...
    //Pre: -
    //Post: Calcula los posibles vecinos a agregar.
    void expandir_vertice(vertice *actual, vertice *vertice_destino, mapa &mapa_callejon,
                          int (*heuristica)(vertice *, vertice *));


    //Pre: -
    //Post: Agrega el vecino al set abierto si este es valido.
    void procesar_vecino(vertice *actual, coordenada vecino, vertice *vertice_destino, mapa &mapa_callejon,
                         int (*heuristica)(vertice *, vertice *));
